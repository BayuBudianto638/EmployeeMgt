...
{
    public abstract class EmployeeMgtWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EmployeeMgtWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EmployeeMgtWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EmployeeMgtDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EmployeeMgtDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EmployeeMgtDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EmployeeMgtDbContext, Task<T>> func)
        {
            T result;
