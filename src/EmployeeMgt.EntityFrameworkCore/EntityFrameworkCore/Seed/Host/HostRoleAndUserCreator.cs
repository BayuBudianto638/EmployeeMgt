...
namespace EmployeeMgt.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        ...
        public HostRoleAndUserCreator(EmployeeMgtDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new EmployeeMgtAuthorizationProvider())
            ...
            if (adminUserForHost == null)
            {
                var user = new User
                {
                    ...
                    Name = "admin",
                    Surname = "admin",
                    EmailAddress = "admin@shiawasesoftware.com",
